...
function MenuPage() {
    ...
    const breakfastItems = getAllCategory?.data?.products;
    // Extract products from all subCategories
            ...
            <div className={'container'}>
                ...
                <div className={'menu-items'}>
                    {breakfastItems?.map((item, index) => (
                        <div key={index} className={`menu-item ${index % 2 === 1 ? '' : 'odd-item'}`}>
                            <div className={'item-header'} onClick={() => item.description && toggleAccordion(index)}>
                ...
                {additionalItems.length > 0 && (
                    <>
                        <div className={'additional-header'}>Əlavə yeməklər</div>
                        <div className={'menu-items'}>
